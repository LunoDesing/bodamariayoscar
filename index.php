...
if (isset($_POST["enviar1"])) {
    ...
    $destinatario1 = "lmgalluis@gmail.com"; #aqui insertar el correo al que deseas que llegue el mensaje que envies en el formulario
    $asunto1 = "nuevo mensaje de $name1 \n \n \n";

    $contenido1 = "Nombre: $name1 \n \n";
    $contenido1 .= "Recomienda: $musica \n \n";

    $header1 = "From: LunoPrueba@net.com"; #aqui insertas el correo del remitente en el encabezado del correo.
...
if (isset($_POST["enviar"])) {
    ...
    $destinatario = "lmgalluis@gmail.com"; #aqui insertar el correo al que deseas que llegue el mensaje que envies en el formulario
    ...
    $header = "From: lunoPrueba@net.com"; #aqui insertas el correo del remitente en el encabezado del correo.
